...
const text = `Los primeros reportes de actividad aeronáutica irregular detectada sobre los municipios del Sotavento 
(Veracruz, Boca del Río, Alvarado y Tlalixcoyan, principalmente) 
datan de finales de los años ochenta. Los habitantes de las zonas agrestes 
-dedicados principalmente a la pesca y la cría de ganado- 
estaban ya habituados a la presencia de las luces nocturnas. 
Los más viejos las llamaban "brujas"; los más informados, "avionetas". 
Incluso conocían el lugar en donde las luces descendían: el Llano de la Víbora, 
una brecha natural bordeada de matorrales y espinos que el Ejército y 
la Policía Judicial Federal empleaban a menudo como pista de aterrizaje.


En esa planicie natural que se elevaba entre charcas y esteros, 
la presencia de soldados y agentes federales era algo común para los habitantes de la zona. 
Después de todo, 
la pista de La Víbora era usada por las fuerzas armadas para realizar maniobras especiales. 
Por ello a nadie le extrañó que, a finales de octubre de mil novecientos noventa y uno, 
llegaran cuadrillas de soldados a tusar la maleza tupida a golpe de machete y limpiar el sendero de obstáculos.
Pero justo una semana después, 
la mañana del siete de noviembre de ese mismo año, el Ejército, 
las autoridades federales y una avioneta Cessna de origen colombiano se vieron envueltos en un sangriento escándalo 
que logró burlar el apretado cerco de censura del gobierno: 
integrantes del Batallón de Infantería del Ejército abrieron fuego contra un grupo de agentes de la procuraduría que habían llegado a La Víbora 
supuestamente a detener a los tripulantes de una avioneta de procedencia colombiana que había sido detectada desde las costas de Nicaragua por el Servicio de Aduanas estadounidense. 
La avioneta Cessna, supuestamente tripulada por traficantes colombianos, 
aterrizó sobre el Llano de la Víbora en la mañana de aquel siete de noviembre, 
seguida de los judiciales. 
Los tripulantes de la avioneta 
-un hombre afroamericano y una mujer rubia, según los testimonios, 
abandonaron su cargamento de trescientos cincuenta 
y cinco kilos de cocaína en costales 
y desaparecieron en el monte, 
mientras que los soldados del Batallón de Infantería, 
apostados en dos columnas a lo largo de la pista, 
aguardaron a que los agentes federales descendieran de su aeronave para abrir fuego contra ellos para "neutralizarlos".


De aquel suceso recuerdo dos fotos que aparecieron en el periódico local Notiver. 
En una de ellas, 
siete hombres yacían en hilera sobre el pasto, 
boca abajo. 
Eran los agentes acribillados por el Ejército. 
Cinco de ellos vestían ropas oscuras y los otros dos iban de paisano, y aunque portaban chamarras negras, 
sucias de tierra y zacate, 
ninguno llevaba zapatos. 
La segunda fotografía mostraba a un agente federal sentado en el suelo, 
con el cañón de un fusil anónimo apuntándole a la cabeza. 
El sujeto, que portaba las siglas de la procuraduría en el pecho, miraba directo hacia la lente. 
Sus labios, congelados a mitad de un espasmo de angustia, 
dejaban entrever una lengua hinchada y reseca: 
se trataba del único judicial que había sobrevivido al ataque.


Era diciembre -o quizás enero o febrero- cuando vi aquellas fotos, 
impresas en una de las páginas de aquel periódico viejo que extendí en el suelo para recoger la hojarasca que pasé la tarde barriendo en el patio. 
Y digo que debió haber sido en estas fechas porque es la única época del año en que los frentes fríos dejan desnudas las copas 
para entonces anaranjadas de los almendros tropicales en el puerto. 
Me recuerdo acuclillada en aquel patio, mirando las imágenes y leyendo con curiosidad las noticias de la sección policiaca extendida sobre el suelo de cemento, 
pero tuvieron que pasar más de diez años para que yo pudiera relacionar aquellas dos imágenes 
-la fotografía de los judiciales muertos y el recuerdo de las extrañas luces de colores que vi en el cielo el verano en que cumplí nueve años- 
y concluir con tristeza que aquel objeto volador no identificado nunca transportó ningún extraterrestre sino puras pacas de cocaína colombiana.
Después del tiroteo de La Víbora y de otros incidentes semejantes ocurridos en Nopaltepec, Cosamaloapan y Carlos A. Carillo, 
y de varios accidentes automovilísticos protagonizados por adolescentes borrachos, 
el gobierno de Boca del Río prohibió las visitas nocturnas a las playas durante algunos meses, así que, después de esa última y decepcionante visita, no volvimos a Playa del Muerto sino hasta finales del noventa y dos, y el sitio, para entonces, había perdido todo su encanto. Nuevas escolleras habían ganado terreno al mar y aquello era un hervidero de vendedores ambulantes y turistas. Incluso habían retirado los escabrosos letreros con calaveras que advertían de las pozas, y con el tiempo, el nombre de Playa del Muerto cayó en desuso a favor de un apelativo más turístico y mucho menos tétrico: Playa Los Arcos.
...
export const Diagnostico = () => {
    ...
    const handleMouseOver = (e) => {
        e.target.style.backgroundColor = mode === 'dark' ? '#3730a3' : '#fde68a'
                        ...
                        <Grid xs={2} sm={1} md={1} lg={1} justifyContent='center'>
                            <Stack spacing={2}>
                                <ButtonGroup orientation="vertical" size="lg" mb={2}>
                                    ...
                                    <IconButton onClick={() => setIsHighlighted(!isHighlighted)}>
                                        <FormatColorFill size={32} color={isHighlighted ? 'primary' : 'neutral'} />
                                    </IconButton>
                                </ButtonGroup>
